...
DRAFT_PANEL: tuple[BrandEntry, ...] = (
    ...
    BrandEntry("Gamma", "B", "gamma.app", "AI presentation software",
               ...
               ambiguity="greek letter; multiple gamma-named companies; "
                         "site 403s scripted fetches (verified via browser UA precedent)"),
    BrandEntry("Granola", "B", "granola.ai", "AI meeting notes app",
               expected_guess=("granola.com",),
               ambiguity="the food — anchor needed"),
    BrandEntry("Amie", "B", "amie.so", "AI calendar and email app",
               expected_guess=("amie.com", "amie.app"),
               ambiguity="French given name — anchor needed"),
    ...
    BrandEntry("GoTo", "C", "goto.com", "IT management and remote work software",
               ...
               ambiguity="site 403s scripted fetches (WAF); domain verified"),
    ...
    BrandEntry("Meta", "C", "meta.com", "social media company",
               ...
               ambiguity="corporate vs product domains — score corporate asks only; "
                         "site 400s scripted fetches (WAF); domain verified"),
    ...
    BrandEntry("Avaza", "D", "avaza.com", "project management and invoicing",
               domain_guessable=True),
    BrandEntry("Paymo", "D", "paymoapp.com", "time tracking and invoicing software",
               expected_guess=("paymo.com", "paymo.biz"),
               ambiguity="canonical verified 2026-09-01: paymo.biz redirects to "
                         "paymoapp.com; paymo.com does not resolve"),
