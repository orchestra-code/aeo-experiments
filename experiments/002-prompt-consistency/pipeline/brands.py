...
#: Coffee-shop / brand-design-agency arm — expect a long tail; curated after
#: its wave lands. Seed with obviously-recurring agency answers.
COFFEE_LEXICON: dict[str, list[str]] = {
    "pentagram": ["pentagram"],
    "landor": ["landor"],
    "wolff olins": ["wolff olins"],
    "interbrand": ["interbrand"],
    "collins": ["collins agency", "collins (agency)"],
    "designstudio": ["designstudio"],
    "ramotion": ["ramotion"],
    "clay": ["clay agency", "clay global"],
    ...
    "motto": ["motto agency", "motto (agency)"],
}
