...
#: Planted effects for the dry run: mat draws from the SAME brand
#: distribution as hum (H1/H2 must come back equivalent), neu2 draws from a
#: REVERSED popularity distribution (H2 must detect the planted mix shift).
PLANT_MIX_SHIFT_ARM = "neu2"
