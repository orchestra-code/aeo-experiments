...
<figure>
  <img
    src="/figures/002-prompt-consistency/subintent-retrieval.svg"
    alt="Two grouped bar panels of pairwise Jaccard overlap for recommended brands, grounding searches, and cited domains. Left panel, travel context: pairs where both prompts mention it overlap most at every layer. Right panel, dollar budget: pairs where both prompts state a budget overlap least on brands, while pairs where neither states one overlap most."
    width="2200"
    height="1000"
  />
  <figcaption>
    Same-day between-prompt pairs split by shared attribute. Travel framing
    (left) converges at every layer; a stated dollar budget (right)
    fragments, because different budgets are different markets. Exploratory.
  </figcaption>
</figure>
...
> Postscript: If you are interested in additional, informed perspectives on the original SparkToro research, [Adam Malamis](https://www.linkedin.com/in/adammalamis/) of [Gander](https://www.takeagander.ai) published a [well-researched article](https://www.linkedin.com/pulse/dissecting-rand-fishkins-resarch-ai-visibility-adam-malamis-jtcac/) reviewing the study from the perspective of someone who works in AI analytics.
## Changelog
