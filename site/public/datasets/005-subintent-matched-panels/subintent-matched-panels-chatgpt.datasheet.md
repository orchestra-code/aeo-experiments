# Sub-intent-matched vs human prompt panels on ChatGPT

- **Study:** 005-subintent-matched-panels
- **Rows:** 1,230 (citations evaluated in this study)
- **License:** CC BY 4.0
- **Released:** 2026-08-06
...
| `panel` | Prompt panel: hum (human survey), mat (profile-stratified scenario generator), neu2 (unstratified scenario generator), coffee (cross-intent control) |
...
- Synthetic prompt text (mat/neu2 panels) is released in the companion dataset subintent-matched-panels-prompts.csv; item_code joins the two files.
